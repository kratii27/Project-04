<%@page import="in.co.rays.proj4.model.PortfolioModel"%>
...
<body>
    ...
    <div align="center">
        <h1 align="center" style="margin-bottom: -15; color: navy;">Portfolio
            List</h1>
        ...
        <form action="<%=ORSView.PORTFOLIO_LIST_CTL%>" method="post">
            ...
            <table style="width: 100%">
                <tr>
                    <td align="center">
                        ...
                        <input type="text" name="portfolioName" placeholder="Enter Portfolio Name"
                            value="<%=ServletUtility.getParameter("portfolioName", request)%>">
                        &emsp;

                        <label><b>Total Value :</b></label> 
                        <input type="text" name="totalValue" placeholder="Enter Total Value"
                            value="<%=ServletUtility.getParameter("totalValue", request)%>">
                        &emsp;
                        
                        <label><b>Created Date :</b></label> 
                        <input type="text" name="createdDate" placeholder="Enter Created Date (MM/dd/yyyy)"
                            value="<%=ServletUtility.getParameter("createdDate", request)%>">
                        &emsp;
            ...
            <table border="1" style="width: 100%; border: groove;">
                ...
                <tr>
                    ...
                    <td style="text-align: center; text-transform: capitalize;"><%=bean.getPortfolioName()%></td>
                    <td style="text-align: center; padding-right: 20px;"><%=bean.getTotalValue()%></td>
                    <td style="text-align: center;"><%=DataUtility.getDateString(bean.getCreatedDate())%></td>
                    <td style="text-align: center;"><%=bean.getCreatedBy() != null ? bean.getCreatedBy() : "System"%></td>
                    <td style="text-align: center;"><%=bean.getModifiedBy() != null ? bean.getModifiedBy() : "System"%></td>
                    <td style="text-align: center;">
            ...
            <table style="width: 100%">
                <tr>
                    ...
                    <td style="width: 25%" align="right">
                        <input type="submit" name="operation" value="<%=PortfolioListCtl.OP_NEXT%>"
